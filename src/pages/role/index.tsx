...
import z from 'zod'
import { addRole, deleteRole, getRolePermission, getRoleTableList, updateRole, updateRolePermission } from '@/request/role'
...
export default function RolePage() {
      ...
      render: (_: any, record: RoleUser) => (
        <div>
          ...
          <Popconfirm
            ...
            cancelText="取消"
          >
            <Button variant="link" className="cursor-pointer">删除</Button>
          </Popconfirm>
        </div>
      ),
    },
  ...
  const [rolePermissionTreeData, setRolePermissionTreeData] = useState<TreeDataNode[]>([])
