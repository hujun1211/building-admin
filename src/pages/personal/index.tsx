...
export default function PersonalPage() {
  ...
  function onSubmit(values: z.infer<typeof passwordFormSchema>) {
    ...
    updatePasswordMutate({ username, newPassword }, {
      onSuccess: () => {
        setDialogOpen(false)
  ...
  return (
    <div className="p-5">
      ...
      <div className="mt-5">
        <Button className="cursor-pointer" variant="link" onClick={() => setDialogOpen(true)}>修改密码</Button>
      </div>
      <div className="mt-5">
        <Button className="cursor-pointer" onClick={handleLogout}>退出登陆</Button>
      </div>
