...
// 控制规则列表
export function getRegulationList(params: RegulationListParams): Promise<RegulationListResponse> {
...
// 手动控制
export function getManualList(params: ManualListParams): Promise<ManualListResponse> {
...
export function getFieldSelectList(property_id: string): Promise<string[]> {
...
export function getRegulationDetails(rule_id: string): Promise<AddRegulationParams> {
